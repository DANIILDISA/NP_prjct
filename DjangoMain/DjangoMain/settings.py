...
SECRET_KEY = 'django-insecure-t(*1qr=h(x@@0%*pr%tj_km7ih)jc2(*9h4)(bev6n954#k%$_'
...
MIDDLEWARE = [
    ...
    'django.contrib.flatpages.middleware.FlatpageFallbackMiddleware',  # change
]
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            os.path.join(BASE_DIR, 'templates'),  # change
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
EMAIL_HOST_USER = 'dennisburn'  # ваше имя пользователя, например, если ваша почта user@yandex.ru,
