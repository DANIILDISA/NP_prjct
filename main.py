"""
(Не обращайте внимания, остатки предыдущего задания)
...
# 1. Переписать представления, под статьи и новости отдельные представления. - работает
# 2. Переписать файлы uls. - надо сделать
# 3. Подумать как оставить минимальное количество шаблонов, а всю логику оставить в views.

# на одной странице было не больше 10 новостей
# и были видны номера лишь ближайших страниц

# добавить JS, сделать сайт красивее, изучить css,
# добавить цветной фон и добавить рыжие элементы
